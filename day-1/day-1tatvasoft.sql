...
INSERT INTO customer (first_name, last_name, email, created_date, updated_date, active) VALUES
  ...
  ('moxa', 'Patel', 'hirenpatel@example.com', NOW(), NULL, false);
...
SELECT last_name, first_name FROM customer WHERE first_name = 'moxa';

SELECT customer_id, first_name, last_name FROM customer WHERE first_name = 'moxa' AND last_name = 'Parejiya';
